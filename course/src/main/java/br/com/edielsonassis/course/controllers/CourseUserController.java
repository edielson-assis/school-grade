...
public class CourseUserController {
	...
	public ResponseEntity<String> saveSubscriptionUserInCourse(@PathVariable UUID courseId, @PathVariable UUID userId) {
		var subscription = courseService.saveSubscriptionUserInCourse(courseId, userId);
